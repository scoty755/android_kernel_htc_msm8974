...
#if defined(CONFIG_MACH_B2_WLJ) && !(defined(CONFIG_HTC_BATT_8960)) || defined(CONFIG_MACH_B2_UL) && !(defined(CONFIG_HTC_BATT_8960))
							...
							int chargecycles)
{
	...
	pr_info("Backup new FCC: fcc_new=%d, chargecycle=%d, pos=%d\n",
						fcc_new, chgcyl, pos);
