...
ifeq ($(CONFIG_MACH_M8)$(CONFIG_MACH_M8_WHL)$(CONFIG_MACH_M8_WL), y)
	...
	dtb-$(CONFIG_ARCH_MSM8974)  += msm8974pro-ab-pm8941-b2wlj.dtb
	dtb-$(CONFIG_ARCH_MSM8974)  += msm8974pro-ab-pm8941-b2wlj-xb.dtb
else ifeq ($(CONFIG_MACH_B2_UL), y)
	dtb-$(CONFIG_ARCH_MSM8974)  += msm8974pro-ab-pm8941-b2ul.dtb
	dtb-$(CONFIG_ARCH_MSM8974)  += msm8974pro-ab-pm8941-b2ul-xb.dtb
else
